...
A tiny C program… but built with the energy of a thousand suns, bro.

This project is a simple, lightweight pixel-level image manipulation tool written in pure C.
Even though the “image” is just a 4×4 matrix, the vibes are real —
...
✨ Brightness Adjustment — make it glow or fade like a moody aesthetic reel
✨ Negative Transform — flips light to dark, vibes to anti-vibes
...
It’s a tiny project but built with love, curiosity, and pure “let’s learn this from scratch” energy.
Keep building, keep experimenting, keep glowing, my dude. 🌙⚡
